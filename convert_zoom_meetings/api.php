...
include(dirname(__FILE__).'/../../../config.php');
include(dirname(__FILE__).'/../../../lib/filelib.php');
...
class zoomapi {
    ...
    function listmeetings($userid) {
        ...
        return $this->make_call('users/'.$userid .'/meetings/', $listmeetingsarray);
    ...
    function listRecordinga($userid) {
        $listrecordingarray = array();
        // $listRecordingArray['host_id'] = $userid;
        return $this->make_call('users/'.$userid .'/recordings/', $listrecordingarray);
    }

    public function getmeetingrecordings($meetingid) {

        return $this->make_call('meetings/'.$meetingid .'/recordings/', []);
    }
