...
function converting_task_local() {
    global $CFG , $DB;
    ...
    local_video_directory_studio_action_local($crops, "crop");
    // Merge.
    $merge = $DB->get_records("local_video_directory_merge", array('state' => 0));
    local_video_directory_studio_action_local($merge, "merge");
    // Cut.
    $cut = $DB->get_records("local_video_directory_cut", array('state' => 0));
    local_video_directory_studio_action_local($cut, "cut");
    // Cat.
    $cat = $DB->get_records("local_video_directory_cat", array('state' => 0));
    local_video_directory_studio_action_local($cat, "cat");
    // Speed.
    $speed = $DB->get_records("local_video_directory_speed", array('state' => 0));
    local_video_directory_studio_action_local($speed, "speed");
}
